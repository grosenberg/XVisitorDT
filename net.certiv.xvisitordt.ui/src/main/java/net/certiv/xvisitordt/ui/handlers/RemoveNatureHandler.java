...
public class RemoveNatureHandler extends AbstractHandler {
	...
	/**
	 * Removes AntlrDT builder/nature on a project. XVisitorNature is automatically added when an AntlrDT
	...
	private void toggleNature(IProject project) {
		try {
			...
			for (int i = 0; i < natures.length; ++i) {
				if (XVisitorCore.getDefault().getNatureId().equals(natures[i])) {
