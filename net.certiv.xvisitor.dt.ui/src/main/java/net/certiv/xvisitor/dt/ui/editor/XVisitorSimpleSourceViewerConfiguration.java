...
public class XVisitorSimpleSourceViewerConfiguration extends XVisitorSourceViewerConfiguration {
	...
	public XVisitorSimpleSourceViewerConfiguration(IPrefsManager store, DslEditor editor, String partitioning) {
		super(null, store, editor, partitioning);
	}

	public XVisitorSimpleSourceViewerConfiguration(DslColorRegistry colorManager, IPrefsManager store, DslEditor editor,
