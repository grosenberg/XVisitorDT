...
public class XvLangManager extends LanguageManager {

	public static final String DSL_NAME = "xvisitor";
	public static final List<String> EXTENSIONS = Arrays.asList("xv");
	...
	public XvLangManager(DslCore core) {
		super(core);
	}
	...
	public DslSourceParser createSourceParser(ICodeUnit unit, String langId) {
		return new XVisitorSourceParser(unit.getParseRecord(langId));
	}
